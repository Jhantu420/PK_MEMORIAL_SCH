  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-[90%] md:max-w-[80%]">
        <h1 className="font-roboto md:font-pacifico font-bold text-orange-400 text-[10vw] sm:text-6xl md:text-7xl drop-shadow-[0_2px_10px_rgba(255,165,0,0.8)]">
          Our Kids Our Pride
        </h1>
        <p className="font-roboto md:font-pacifico text-white text-[4vw] sm:text-xl md:text-2xl mt-3 leading-relaxed tracking-wide drop-shadow-[0_2px_10px_rgba(252,192,0,0.8)]">
